...
function updateBorder(bestOf) {
	document.getElementById('borderP1').setAttribute('src', 'Resources/Overlay/Scoreboard 4.3/Border ' + bestOf + '.png');
	document.getElementById('borderP2').setAttribute('src', 'Resources/Overlay/Scoreboard 4.3/Border ' + bestOf + '.png');
	bestOfPrev = bestOf
}
...
function updateWL(pWL, playerNum) {
	...
	if (pWL == "W") {
		pWLEL.setAttribute('src', 'Resources/Overlay/Scoreboard 4.3/[W].png')
	} else if (pWL == "L") {
		pWLEL.setAttribute('src', 'Resources/Overlay/Scoreboard 4.3/[L].png')
	}
